        ...
        while (!_quit) {
            ...
            if (elapsedMovingAverage > _maxElapsedAverage) {
                qCDebug(interfaceapp_deadlock)
                    ...
                    << "ms elapsedMovingAverage:" << elapsedMovingAverage / USECS_PER_MSEC << "ms maxElapsed:" << _maxElapsed
                    << "PREVIOUS maxElapsedAverage:" << _maxElapsedAverage / USECS_PER_MSEC
                    << "ms NEW maxElapsedAverage:" << elapsedMovingAverage / USECS_PER_MSEC
                    << "ms ** NEW MAX ELAPSED AVERAGE **"
            ...
            if (lastHeartbeatAge > MAX_HEARTBEAT_AGE_USECS) {
                qCDebug(interfaceapp_deadlock)
                    << "DEADLOCK DETECTED -- "
                    << "lastHeartbeatAge:" << lastHeartbeatAge / USECS_PER_MSEC
                    << "ms [ lastHeartbeat :" << lastHeartbeat / USECS_PER_MSEC << "ms now:" << now / USECS_PER_MSEC << "ms ]"
