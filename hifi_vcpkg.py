    ...
    def __init__(self, args):
        ...
        if 'Windows' == system:
            ...
            if ('CI_BUILD' in os.environ) and os.environ["CI_BUILD"] == "Github":
                self.prebuiltArchive = "https://hifi-public.s3.amazonaws.com/dependencies/vcpkg/builds/258877bd/258877bd-win32.zip"
        elif 'Darwin' == system:
            ...
            self.bootstrapEnv["SDK_NAME"] = "macosx10.15"
            self.bootstrapEnv['MACOSX_DEPLOYMENT_TARGET'] = '10.15'
            self.buildEnv['MACOSX_DEPLOYMENT_TARGET'] = '10.13'
            if ('CI_BUILD' in os.environ) and (os.environ["CI_BUILD"] == "Github") and (not self.noClean):
                self.bootstrapEnv["DEVELOPER_DIR"] = "/Applications/Xcode_11.1.app"
                self.buildEnv["DEVELOPER_DIR"] = "/Applications/Xcode_11.1.app"
